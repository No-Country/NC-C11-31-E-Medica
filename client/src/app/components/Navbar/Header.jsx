        ...
        <button className="header-menu-mobile" onClick={changeNavbar}>
          ...
          >
            <path
              ...
              fill="#1E202D"
              className={`header-path-2 ${
                openNavbar ? "header-open-path-1" : "header-open-close-2"
              }`}
            />
            <path
              ...
              fill="#1E202D"
              className={`header-path-1 ${
                openNavbar ? "header-open-path-2" : "header-close-1"
              }`}
            />
            <path
              ...
              fill="#1E202D"
              className={`header-path-3 ${
                openNavbar ? "header-open-path-3" : "header-open-close-3"
              }`}
            />
          </svg>
        </button>
