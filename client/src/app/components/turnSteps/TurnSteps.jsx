    ...
    <div className='information'>
      ...
      <section className='steps'>
        ...
        <article>
          ...
          <p>Mirá toda la disponibilidad del profesional, eligiendo el dia y el horario</p>
        </article>
        <article>
          <h3>
            <span className='growUp'>3</span>er paso
          </h3>
          <p>Registrá tu turno en la agenda médica. Recibiras la confirmación por e-mail y recordatorios por mensajes de texto</p>
        </article>
        <article>
          <h3>
            <span className='growUp'>4</span>to paso
          </h3>
          <p>Espera el turno en el horario y dia acordado. Te recomendamos estar conectado 5min antes.</p>
        </article>
      </section>
    </div>
  )
